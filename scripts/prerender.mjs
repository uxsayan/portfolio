...
// ── Per-route meta ────────────────────────────────────────────────────────────
const META = {
  "genai-traces":          { title: "Gen AI Traces & Failures — IBM Instana | Sayan Chakraborty",                          description: "Full UX ownership on Gen AI observability inside IBM Instana — Task Hierarchy View, Trajectory, and Cycle Detection. By Sayan Chakraborty, UX Designer at IBM.",               ogImage: "https://www.uxsayan.in/images/genai-traces/Hero.png" },
  "business-impact":       { title: "Business Impact: Conversion Goals & Funnels — IBM Instana | Sayan Chakraborty",        description: "UX and visual design for Conversion Goals and Funnels inside Instana's RUM Business Impact tab — correlating user drop-off with technical performance. By Sayan Chakraborty.",  ogImage: "https://www.uxsayan.in/images/Business%20Impact%20EUM/Hero.png" },
  "instana-incident-remediation": { title: "Instana Incident Remediation — iF Design Award | Sayan Chakraborty",            description: "Contributed to IBM Instana's agentic AI incident response — an iF Design Award submission. Autonomous agents surface root causes in seconds, cutting MTTR by up to 80%.",          ogImage: "https://www.uxsayan.in/images/IBM%20IF%20Design%20Award/Hero.png" },
  "ibm-connector-workflow":{ title: "Companion Panel — IBM Connector Content Workflow | Sayan Chakraborty",                  description: "Led design on a cross-functional workflow redesign for connector documentation across product, content, and engineering teams at IBM. By Sayan Chakraborty.",                       ogImage: "https://www.uxsayan.in/images/Companion%20panel/Hero.png" },
  ...
  "ibm-design-challenge":  { title: "Evo-connect — IBM Design Challenge (12-Hour Sprint) | Sayan Chakraborty",              description: "IBM hiring design challenge: designed an iPhone app for a flagship EV with full vehicle control — research through final design in 12 hours. By Sayan Chakraborty.",             ogImage: "https://www.uxsayan.in/images/Design%20challenge/Tata%20cover.png" },
};
