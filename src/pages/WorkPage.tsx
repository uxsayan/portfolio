...
const META: Record<string, { title: string; description: string; ogImage: string }> = {
  ...
  "business-impact": {
    ...
    ogImage: "https://www.uxsayan.in/images/Business Impact EUM/Hero.png",
  },
  "instana-incident-remediation": {
    ...
    ogImage: "https://www.uxsayan.in/images/IBM IF Design Award/Hero.png",
  },
  "ibm-connector-workflow": {
    ...
    ogImage: "https://www.uxsayan.in/images/Companion panel/Hero.png",
  },
  "tusk": {
  ...
  "ibm-design-challenge": {
    ...
    ogImage: "https://www.uxsayan.in/images/Design challenge/Tata cover.png",
  },
};
